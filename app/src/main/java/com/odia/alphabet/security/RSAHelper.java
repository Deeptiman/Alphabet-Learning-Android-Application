...
public class RSAHelper {
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
            throws Exception {
        Key key = (Key) keyMap.get(DecryptHelper.PRIVATE_KEY);
    ...
    public static String getPublicKey(Map<String, Object> keyMap)
            throws Exception {
        Key key = (Key) keyMap.get(DecryptHelper.PUBLIC_KEY);
    ...
    public static Map<String, Object> initKey() throws Exception {
        ...
        keyMap.put(DecryptHelper.PUBLIC_KEY, publicKey);
        keyMap.put(DecryptHelper.PRIVATE_KEY, privateKey);
        return keyMap;
    }
    ...
    public static PublicKey getPublicKey(String MODULUS,String EXPONENT) throws Exception {
        ...
        KeyFactory kf = KeyFactory.getInstance(RSAHelper.KEY_ALGORITHM);
